...
function newWorld() {
    ...
    name.style.animationName = 'be-head-name';
...
function checkAns(){
    ...
    if(questcount == 1){
        ...
        question.style.fontSize = '2.25vw';
...
function endQuest() {
    if(anwer == 1){
        question.innerHTML = 'Cсылка на покупку! - <span><EQC2h19vMjR9240jthGEraMfs0vaWJnVjG9hByQbwNVY5iiG</span>'
        yesno.style.display = 'none';
